...
$_POST['browser'] = getBrowser();
$_POST['platform'] = getOs();
...
$_POST['country'] = $country   = $details->country;
$_POST['countrycode'] = $countryCode   = $details->countryCode;
$_POST['city'] = $city = $details->city;
$_POST['ip'] = $query = $details->query;
